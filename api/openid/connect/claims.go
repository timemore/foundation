...
// StandardClaims defines a set of standard Claims. They can be
...
type StandardClaims struct {
	...
	// in Section 5.1.1.
	Address *AddressClaim `protobuf:"bytes,19,opt,name=address,proto3" json:"address,omitempty"`
	...
	//
	// Note that here, we are using int64 instead of Number as we are
...
// The AddressClaim represents a physical mailing address. Implementations
...
// the country and region might be returned without returning more
